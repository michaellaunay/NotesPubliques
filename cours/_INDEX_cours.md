...
- [[Les CNN et RNN]] — Cours de niveau master sur les réseaux convolutifs et récurrents : convolution, champs réceptifs, architectures CNN modernes, récurrence, LSTM/GRU, entraînement des séquences, Seq2Seq, attention et positionnement face aux Transformers et modèles d'état modernes.
